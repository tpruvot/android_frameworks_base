...
*/
    ...
    int RIL_REQUEST_SIM_TRANSMIT_BASIC = 108;
    int RIL_REQUEST_SIM_OPEN_CHANNEL = 109;
    int RIL_REQUEST_SIM_CLOSE_CHANNEL = 110;
    int RIL_REQUEST_SIM_TRANSMIT_CHANNEL = 111;
